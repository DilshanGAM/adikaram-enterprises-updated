...
function ReturnBillPage() {
    ...
    useEffect(() => {
        ...
        if (!token) {
            ...
            axios
                .get(`/api/invoicing/extended?id=${returnBillId}`, {
    ...
    return (
        <div className="w-full max-w-4xl mx-auto p-6 space-y-6">
            ...
            <Card className="shadow-md relative">
                ...
                <CardContent>
                    ...
                    <IoPrintSharp  className="absolute right-1 top-1" onClick={()=>{
                        ...
                        {/*//tobechenged <p><span className="font-semibold">Shop Name:</span> {invoice.shop.name}</p>
            ...
            <Table>
                <TableHeader>
                    <TableRow>
                        {/*//tobechenged <TableHead>Product</TableHead>
                ...
                <TableBody>
                    {/*//tobechenged {invoice.items.length > 0 ? (
            ...
            <Table>
                ...
                <TableBody>
                    {/*//tobechenged {invoice.free_items.length > 0 ? (
            ...
            <Card className="shadow-md">
                ...
                <CardContent>
                    <div className="grid grid-cols-2 gap-4">
                        {/*//tobechenged and should be add the covered in bill info <p><span className="font-semibold">Total Amount:</span> ${invoiceTotal.toFixed(2)}</p>
